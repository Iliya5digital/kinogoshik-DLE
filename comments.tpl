<div class="comment-item js-comm">
	...
	[not-available=lastcomments]<div class="comment-item__footer d-flex ai-center">
		<div class="comment-item__reply">[reply]Ответить<span class="fas fa-angle-down"></span>[/reply]</div>
		<div class="comment-item__reply">[fast]<span class="fas fa-redo-alt"></span>Цитировать[/fast]</div>
